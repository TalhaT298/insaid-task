  ...
  <section class="mb-32 text-gray-800 text-center">
    ...
    <div class="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
      <div class="mb-12 md:mb-0">
        ...
        <h6 class="font-medium text-blue-600 mb-4">Businessman</h6>
        <p class="mb-4">
        ...
        <ul class="flex justify-center mb-0">
          <li>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="w-4 text-red-900"
          ...
          <li>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star-half-alt"
              class="w-4 text-red-900" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 536 512">
              <path fill="currentColor"
      ...
      <div class="mb-12 md:mb-0">
        ...
        <p class="mb-4">
          ...
          </svg>One of the best places I’ve eaten on BakeBy. Great cocktails, awesome..
        </p>
        <ul class="flex justify-center mb-0">
          <li>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="w-4 text-red-900"
      ...
      <div class="mb-0">
        ...
        <p class="mb-4">
          ...
          </svg>Best Pizza EVER! Not just on the lower Cape…. anywhere.
        </p>
        <ul class="flex justify-center mb-0">
          <li>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="w-4 text-red-900"
          ...
          <li>
            <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="star" class="w-4 text-red-900"
              role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
              <path fill="currentColor"

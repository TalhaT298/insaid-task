...
const Contact = () => {
    return (
        ...
        <section class="relative z-10 overflow-hidden bg-white lg:py-[120px] px-20">
              ...
              <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                  ...
                  <p class="text-body-color mb-9 text-base leading-relaxed">
                    We also provide best online service 
                  </p>
                  <div class="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div class="w-full">
                      ...
                      <p class="text-body-color text-base">
                        99 S.t Jomblo Park Pekanbaru 28292. Bangladesh
                      </p>
                    </div>
                  </div>
                  <div class="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div class="w-full">
                      ...
                      <p class="text-body-color text-base">(+880) 1785030648</p>
                    </div>
                  </div>
                  <div class="mb-8 flex w-full max-w-[370px]">
                    <div
                    ...
                    <div class="w-full">
                      ...
                      <p class="text-body-color text-base">info@bakeby.com</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <form>
                    <div class="mb-6">
                      <input
                        ...
                        class="text-body-color border-[F0F0F0] focus:border w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                      />
                    </div>
                    <div class="mb-6">
                      <input
                    ...
                    <div class="mb-6">
                      <textarea
                        ...
                        class="text-body-color border-[F0F0F0] focus:border- w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                      ></textarea>
                    </div>
                    <div>
                      <button
